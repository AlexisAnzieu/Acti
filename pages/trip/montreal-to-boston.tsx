          ...
          <Box className="timeline">
            <Box className="card">
              <Box className="info">
                ...
                <Text>
                  ...
                  est nécessaire afin de se munir de nouvelles sacoches. Ne les
                  ayant pas ou peu expérimentées, elles se détachent du
                  ...
                  voyant s’afficher les 80 kilomètres subsistants, adieu chaises
                  longues. Les paysages identiques de champs à perte de vue
                  s’enchaînent. Les pistes cyclables ombragées restent agréables
                  à utiliser. Les dix derniers kilomètres en montée sous le
                  soleil encore brûlant à côté d’une route à forte affluence
                  mettent nos nerfs à dure épreuve. Effort contrasté par notre
                  arrivée à l’auberge de Knowlton qui se déroule en toute
                  quiétude, nous sommes les seuls clients. Le gérant nous confie
                  les clés de son établissement avant de rentrer chez lui. Nous
                  sommes maintenant les heureux propriétaires d’une bâtisse de
                  50 chambres. Après application d’un peu de vaseline
                  réparatrice permettant des futurs moins douloureux sur la
                  selle, nous voilà en route pour la marina afin de récupérer de
                  quoi nous sustenter. Nous en profitons au passage pour glisser
                  un orteil dans l’eau de la piscine. Demain, nous avons prévu
                  de traverser la frontière américaine à vélo en passant par un
                  petit poste de douane. Nous espérons que l’aventure ne va pas
                  s’arrêter là.
                </Text>
              </Box>
            </Box>
            <Box className="card">
              <Box className="info">
                ...
                <Text>
                  ...
                  cinq premiers kilomètres en montée demeurent douloureux et les
                  courbatures font leurs premières apparitions. Cependant, les
                  20 km suivants se déroulent en descente et nous permettent
                  donc d’apprécier un échauffement tranquille. Nous apercevons
                  les montagnes du Vermont au loin, regrettant déjà les terrains
                  plats de la veille. La fin de cette matinée nous amène
                  directement au poste-frontière. Le douanier nous accueille
                  avec l’amabilité d’un douanier, c’est-à-dire qu’il sait où
                  placer la barre du sourire, et c’est plutôt bas. Il nous pose
                  des questions sur le lieu de notre première rencontre, ce
                  qu’on va effectuer à Boston, à quelle date nous sommes arrivés
                  au Canada… En somme des thèmes qu’on énoncerait à un touriste
                  qu’on vient de croiser dans un bar excepté que là, une
                  mauvaise réponse peut nous mener en cellule. Les menottes
                  fixées au banc ne nous rassurent pas. Dix longues minutes plus
                  tard,{" "}
                  <a
                    data-tooltip-id="my-tooltip"
                    href="/images/bostontrip/poste-frontiere.jpeg"
                  ...
                  américains plantés dans les jardins flottent au gré du vent et
                  un panneau LED accroché sur la devanture d’une église
                  ...
                  malheureusement pas dans notre alimentation végétarienne. Nous
                  sommes sauvés in extremis par un Subway juxtaposé à une
                  station-service.
                  <a
                    data-tooltip-id="my-tooltip"
                    href="/images/bostontrip/subway.jpeg"
                  ...
                  notre premier repas américain. Quelques kilomètres après notre
                  départ, un porte-bagages se fait la malle (sans mauvais jeu de
                  mots). Nous nous posons donc sur le bas-côté à la recherche de
                  la vis perdue, sous l’atmosphère étouffante de l’après-midi.
                  Cinq minutes plus tard, un jeune garçon sort de sa maison, une
                  limonade à la main et nous l’offre, une délicate attention qui
                  mérite cet hommage dans ce récit. Au Vermont, les routes de
                  ...
                  giboyeuses et ensablées. Une monture profita de cette occasion
                  pour s’y embourber. Cette voie boueuse fut suivie de ce que
                  l’on renomma la ligne rouge.{" "}
                  <a
                    data-tooltip-id="my-tooltip"
                    href="/images/bostontrip/ligne-rouge.jpeg"
                  >
            ...
            <Box className="card">
              <Box className="info">
                ...
                <Text>
                  ...
                  n’arrêtait pas de claquer. Le temps d’avaler deux tranches de
                  muffins et nous voilà repartis pour notre troisième journée.
                  Le désagréable repos est vite oublié par les 20 km de sentiers
                  composés
                  <a
                    data-tooltip-id="my-tooltip"
                    href="/images/bostontrip/pont1.jpeg"
                  ...
                  veille, suffisamment pour continuer à apprécier les chaleureux
                  « good morning ». Nous nous délectons{" "}
                  <a
                    data-tooltip-id="my-tooltip"
                    href="/images/bostontrip/mont.jpeg"
                  >
                  ...
                  dévolu sur un petit café situé à une vingtaine de kilomètres.
                  Après la douceur du sentier, nous voici de retour sur la
                  rigueur de la route un peu assourdissante à cause des 33
                  tonnes passant à côté de nous de vives allures. Toutefois,{" "}
                  <a
                    data-tooltip-id="my-tooltip"
                    href="/images/bostontrip/piste.jpeg"
                  >
                  ...
                  de son moteur. Nous avons cependant du mal à différencier les
                  gros camions de marchandises des énormes trucks. Une montée
                  douloureuse fut suivie d’une glissade de 2 km à grande allure
                  pour finir dans le petit café de Stowe. Très agréablement
                  surpris par la qualité de la nourriture et des breuvages. Il
                  est 13 h 30 et notre seule envie jouxtant ce repas est de
                  s’allonger et dormir. Mon camarade Antoine{" "}
                  <a
                    data-tooltip-id="my-tooltip"
                    href="/images/bostontrip/antoineronfle.jpeg"
                  >
                  ...
                  dénivelé de 700 mètres en une trentaine de minutes, un effort
                  intense accompagné des 30° qui tape sur le crâne à travers le
                  casque. Au bout d’un certain temps, nous arrivons à caler
                  notre pédalage sur notre souffle. Nous avons l’impression de
                  réapprendre à respirer. C’est toujours aussi pénible, mais au
                  moins nous avançons avec la confiance d’arriver à bon port.
                  Nous avons l’impression de grimper la pente moitié après
                  moitié sans jamais en voir le bout. En haut de la côte,
                  délivrance, la douce joie du vent de la descente annihile la
                  peine de la montée. Nous essayons cependant de faire
                  attention, car à cette vitesse le moindre écart de chaussée
                  pourrait nous être fatal. La concentration sur la route reste
                  une routine à laquelle nous nous sommes rapidement habitués,
                  une sorte de méditation forcée de plusieurs heures par jour.
                  Mais ça ne sera pas sur la pente qu’un problème surviendra. En
                  effet, voici venue l’heure de la première crevaison, 5 minutes
                  avant l’arrivée, quelle aubaine ! Nous réussissons cependant à{" "}
                  <a
                    data-tooltip-id="my-tooltip"
                    href="/images/bostontrip/crevaison.jpeg"
                  >
                  ...
                  nous et dégustation d’un cidre normand pas tout à fait local.
            ...
            <Box className="card">
              <Box className="info">
                ...
                <Text>
                  ...
                  kilomètres. Heureusement, nous résidons en haut d’un col et ce
                  matin ne sera que descente. Les paysages pluvieux apportent{" "}
                  <a
                    data-tooltip-id="my-tooltip"
                    href="/images/bostontrip/brume.jpeg"
                  >
                  ...
                  , la brume se glissant entre les arbres larmoyants. L’odeur de
                  la terre mouillée et le peu de circulation transforment cette
                  heure d’inquiétude en temps de plénitude. Dans la vallée, nous
                  nous faisons doubler par un, puis deux, puis cinq, puis une
                  dizaine de cyclistes. Mais que se passe-t-il donc ? Une course
                  ! Et nous nous trouvons dedans. Nous entamons un dernier
                  sprint jusqu’à la boutique afin de monter sur le podium, bien
                  évidemment. Nous entrons alors dans{" "}
                  <a
                    data-tooltip-id="my-tooltip"
                    href="/images/bostontrip/alibaba.jpeg"
                  >
                  ...
                  loups de mer. L’ambiance chaleureuse nous force à conter notre
                  aventure, un peu écourtée du fait de notre patois peu habitué
                  à des accents si prononcés. Le pneu est remplacé et la chambre
                  à air gonflée. Nous sommes prêts à affronter cette deuxième
                  partie de journée sous le gourou de Zeus, dieu de la pluie.
                  Mais avant, place à la boustifaille située à quelques mètres
                  de là.{" "}
                  <a
                    data-tooltip-id="my-tooltip"
                    href="/images/bostontrip/boustifaille.jpeg"
                  ...
                  défier les torrents d’eau à coup de pédales. La pause déjeuner
                  se prolonge sur 2 heures. Un gros milk-shake au café en sonne
                  le glas. Le départ est compliqué. La sérotonine ne subsiste
                  plus dans le sang, les vêtements sont mouillés, nous
                  commençons doucement à trouver l’averse longue. Les paysages
                  toujours aussi beaux et détrempés se succèdent par une montée
                  d’une vingtaine de kilomètres. Des ruisseaux coulent le long
                  de la route et viennent se déchaîner contre nos roues qui
                  glissent à reculons. Éclaboussures, sueurs et pluie
                  torrentielle, pénible cocktail de cette fin de journée. Tandis
                  que nous arrivons enfin à l’auberge, le réceptionniste nous
                  accueille avec son discours habituel de bienvenue. Nos
                  oreilles frémissent quand nous entendons que le jacuzzi ferme
                  sous peu. Un jacuzzi dites-vous ? Cinq minutes plus tard, nous
                  sautons de l’eau subite vers l’eau bénite. Pour finir la
                  soirée, le hasard accomplissant bien les choses,{" "}
                  <a
                    data-tooltip-id="my-tooltip"
                    href="/images/bostontrip/gastro.jpeg"
                  >
                  ...
                  pouvoir nous ravitailler correctement avant d’entamer la plus
                  difficile et tortueuse journée de notre expédition, 100
            ...
            <Box className="card">
              <Box className="info">
                ...
                <Text>
                  Nous appréhendons quelque peu cette journée. Le petit déjeuner
                  n’apparaît pas copieux, mais suffira à nous faire patienter
                  jusqu’à midi. Étant servi sur place, il présente l’avantage de
                  nous permettre de poser rapidement le pied sur l’étrier.
                  Durant les cinq premières minutes, nous dévalons l’heure
                  d’ascension de la veille. S’enchaînent ensuite des paysages
                  montagneux,{" "}
                  <a
                    data-tooltip-id="my-tooltip"
                    href="/images/bostontrip/lac.jpeg"
                  ...
                  de tracés lisses, de peu de trafic et d’oiseaux toujours aussi
                  vivants, heureux de chanter le printemps. Nous profitons
                  d’autant plus de ces paysages demeurant au fait que quelques
                  kilomètres plus loin nous attend la montée la plus abrupte de
                  notre voyage. Enfin, elle apparaît là, en face de nous,
                  débutant sur une route cabossée. Nous ne regardons pas le GPS
                  de peur de nous démotiver, nous savons que nous avancerons
                  jusqu’au bout quoiqu’il arrive. Nous croisons trois cyclistes
                  qui descendent et qui nous saluent avec un grand sourire,
                  mauvais signe. Le dénivelé démarre à 8 %, pour finir à 12. Et
                  en même temps, la nature apaise l’effort, nous nous trouvons
                  sous les arbres, le soleil ne nous harcèle pas directement, il
                  ne pleut plus et la température apparaît idéale. Trente
                  minutes plus tard, nous voici en haut dégoulinant de sueurs,
                  mais fiers de ne pas avoir mis un pied à terre. Nous attrapons
                  nos gourdes et récompensons nos muscles à coup de grosses
                  gorgées d’eau, pressé d’entamer la descente. Prenons
                  d’ailleurs un instant pour en parler. Le plus plaisant n’est
                  pas la descente en elle-même. Si nous n’avions fait que
                  descendre, la jouissance aurait été moindre. Le vrai plaisir
                  provient de l’écart émotionnel entre l’effort intense et
                  l’effort néant. Nous en venons à apprécier les hauts
                  dénivelés, sachant qu’après une descente s’ensuit.
                  L’adrénaline de la vitesse et la sérotonine sécrétée par les
                  muscles au cours de la montée transforment ces quelques
                  minutes en moments de joie pure. Nous crions, nous hurlons,
                  nous sommes les rois du monde durant ces courts instants. Et
                  si parfois nous mettons un pied à terre lors de l’effort, ce
                  n’est pas une défaite. D’autres luttes suivront sur lesquelles
                  nous prendrons l’avantage. Au bas de cette montagne, la
                  transition entre la frontière du Vermont et du New Hampshire
                  apparaît rude. Nous passons des doux paysages verdoyants aux
                  quatre voies américaines, sponsorisées par la poussière et les
                  monstres carbonés mécaniques. La maigre piste cyclable à notre
                  disposition est garnie de trous, ce qui ne facilite pas notre
                  avancée. Pour ce midi, nous avions décidé d’aller manger à
                  l’unique restaurant de la contrée qui proposait des plats
                  végétariens. Malheureusement une fois devant, un taudis à
                  moitié abandonné nous attend. Nous sommes entourés de Pizza
                  Hut, McDonald’s et Burger King qui règne en maîtres dans ses
                  vallées infernales. Notre seule solution consiste donc à
                  chercher de quoi se sustenter dans le supermarché du coin puis
                  de le consommer{" "}
                  <a
                    data-tooltip-id="my-tooltip"
                    href="/images/bostontrip/parking.jpeg"
                  ...
                  Maps n’est vraiment pas fort avec les angles. Komoot n’est pas
                  très précis. Il est donc compliqué d’estimer avec certitude
                  dans quelle situation nous nous retrouverons dans les cinq
                  prochains kilomètres. Cet après-midi resta incontestablement
                  notre pire désillusion concernant l’effort physique qu’il nous
                  restait à accomplir, qu’à cela ne tienne. À coup de pied à
                  terre, d’hydratation et de jurons, nous arrivons à
                  destination. Nous avions réservé cet hôtel la veille sans trop
                  savoir à quoi se préparer et une fois de plus nous ne sommes
                  pas déçus de l’endroit. Étant en basse saison, les gîtes haut
                  de gamme gisent vides et financièrement accessibles. Une
                  piscine nous attend, il est grand temps d’un plouf. Ce soir,
                  le seul pub du coin est irlandais, notre dévolu est donc jeté
                  sur un fish & chips, toujours aussi régional. Un petit concert
                  est au rendez-vous, de même qu’un accent qui se veut de plus
                  en plus incompréhensible pour nos oreilles chauvines. Plus que
            ...
            <Box className="card">
              <Box className="info">
                ...
                <Text>
                  ...
                  transforment en montée et les montées quant à elles n’offrent
                  pas plus de résistance que d’habitude due à notre lenteur.
                  Nous pourrions nous plaindre de notre sort, cependant ce vent
                  nous a sauvés de quelques problèmes respiratoires. Les forêts
                  canadiennes sont en proie aux flammes et génèrent des cendres
                  à des milliers de kilomètres à la ronde, Montréal est
                  ...
                  juste avant notre pause de mi-journée. Le trajet apparut moins
                  éprouvant que nous le pensions. Pas une seule goutte de pluie
                  jusqu’au déluge en début d’après-midi, alors que nous nous
                  trouvions à l’intérieur d’une supérette afin d’y acheter notre
                  déjeuner. L’heureux hasard frappant pour la énième fois.
                  Tandis que l’eau s’abattait sur le bitume, nous effectuâmes la
                  rencontre d’un personnage intéressant. Il complimenta nos
                  vélos avant de commencer à conter sa vie. D’après ses dires,
                  il était le créateur des pédales à clips et en avait eu l’idée
                  en travaillant chez Salomon en France à l’époque pour les
                  fixations de ski. Nous sommes quelque peu étonnés de croiser
                  un individu aussi brillant et connu dans son domaine dans un
                  village rural et loin de tout. Tel un homme d’affaires
                  américain, il nous vante les mérites de son génie et nous
                  offre une réduction sur sa prochaine trouvaille : de nouveaux
                  ancrages futuristes pour les skis. Nous apparaissons
                  dubitatifs quant à la véracité de ses propos, néanmoins après
                  vérification nous nous rendons compte que nous avons bel et
                  bien rencontré l’inventeur de ces clips qui nous ont permis de
                  moins peiner lors des montées. L’orage s’arrête. Nous
                  reprenons l’itinéraire jusqu’à notre destination : une aire
                  d’autoroute. Ici, la voiture est reine, pas de corridor pour
                  les piétons, pas de casier à vélo dans les hébergements. Les
                  gens vont de l’hôtel au restaurant dans leur pick-up, au
                  diable les quelques minutes de marche en extérieur.
                  Heureusement, nous ne sommes que de passage, car demain c’est
                  le grand jour. C’est l’arrivée à Boston.
                </Text>
              </Box>
            </Box>
            <Box className="card">
              <Box className="info">
                ...
                <Text>
                  ...
                  agréablement surpris par le petit déjeuner bien achalandé qui
                  nous transportera sur les 80 km restants. Le vent demeure
                  encore présent et le trafic ubiquitaire lorsque nous entamons
                  les premiers kilomètres.Nous traversons{" "}
                  <a
                    data-tooltip-id="my-tooltip"
                    href="/images/bostontrip/aire.jpeg"
                  >
                  ...
                  prendre. Il déboulait d’on ne sait où de derrière les fagots.
                  On aurait dit une caméra cachée. Enfin, le corridor ombragé
                  tant attendu nous amène d’une traite à Boston. Les pick-up se
                  font graduellement plus rares, remplacés par des voitures
                  citadines. Les conducteurs apparaissent de plus en plus
                  respectueux et les voies dédiées au vélo se trouvent
                  progressivement plus larges. En contrepartie, moins de
                  salutations de la part des autres cyclistes, davantage
                  habitués à en voir d’autres. Au fur et à mesure que nous nous
                  enfonçons dans la ville,{" "}
                  <a
                    data-tooltip-id="my-tooltip"
                    href="/images/bostontrip/boston.jpeg"
                  >
                  ...
                  idée en tête. Avant même de se prendre en photos au devant de
                  ces fameuses institutions. C’est de poser nos vélos, laver nos
                  affaires, puis nous débarbouiller. Et dire qu’enfin nous
