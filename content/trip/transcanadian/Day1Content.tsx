...
export const Day1Content = () => (
  <VStack spacing={6} align="stretch">
    <Box>
      ...
      <Text lineHeight="1.8" mb={4}>
        Nous voilà enfin au Jour 1 ! De retour à la gare avec une bonne heure d'avance à la recherche du train numéro 001. L'enregistrement se déroule dans le salon business, qui ne doit son nom qu'à ses fauteuils émaillés par le temps. Le distributeur de café-filtre à disposition ne nous émerveille pas vraiment. Nous décidons de partir à la recherche d'un Starbucks, afin d'allier un soupçon de présent à ces vestiges du passé.
      </Text>
