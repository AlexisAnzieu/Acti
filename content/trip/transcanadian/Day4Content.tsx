...
export const Day4Content = () => (
  <VStack spacing={6} align="stretch">
    <Box>
      ...
      <Text lineHeight="1.8" mb={4}>
        Pour le dernier soir, nous avons demandé à être en tête-à-tête. Ayant choisi le troisième service à 20h, ce qui correspond à 23h, 3 jours plus tôt. Notre jauge d'énergie est limitée et nous ne sommes apparemment pas les seuls car tous les autres couples du wagon ont décidé de manger seuls. La fin de l'aventure est imminente.
      </Text>
      ...
      <Text lineHeight="1.8" mb={4}>
        Levés à 9h, nous apprenons que sommes arrivés avec trois heures d'avance à destination. Le conducteur n'a fait aucune annonce afin de nous laisser dormir paisiblement, qu'il en soit chaleureusement remercié. D'après l'intendant du wagon, le planning du trajet est établi en prévoyant une marge de six heures à cause de la priorité du fret ferroviaire. Coup de chance, le fret était très léger cette semaine.
      </Text>
